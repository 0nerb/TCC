...
\hline
\textbf{Camada} & \textbf{Tecnologia} & \textbf{Função} \\ \hline
Coleta e transformação & \textit{Python}, \textit{pandas}, \textit{yfinance}, \textit{Tableau} & Extração, tratamento e cálculo de risco \\ \hline
Armazenamento & PostgreSQL & Data Warehouse dimensional \\ \hline
Aplicação & Node.js, Express & API REST analítica \\ \hline
Visualização & React, Recharts & Painel interativo \\ \hline
\end{tabular}
